...
function InterviewPage() {
    ...
    // Add effect to read question whenever question changes
    useEffect(() => {
        if (gQtns[currentQuestionIndex]) {
            handleSpeak(gQtns[currentQuestionIndex]);
        }
        ...
        <div className='questionDisplay-div'>
            ...
            <div className='question-div'>
                ...
                <button 
                    ...
                    onClick={() => isSpeaking ? stopSpeaking() : handleSpeak(gQtns[currentQuestionIndex])}
                >
